...
public class Registers {
    ...
    public String getAcquiantanceCosmetic() {
        return acquiantanceCosmetic;
    }

    public void setAcquiantanceCosmetic(String acquiantanceCosmetic) {
        this.acquiantanceCosmetic = acquiantanceCosmetic;
    }

    public String getAdmissionReg() {
        return admissionReg;
    }

    public void setAdmissionReg(String admissionReg) {
    ...
    public String getParentsMeeting() {
        return parentsMeeting;
    }

    public void setParentsMeeting(String parentsMeeting) {
    ...
    public void setStockIssueProv(String stockIssueProv) {
