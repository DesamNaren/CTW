...
public class AcademicOverview {
    ...
    public void setPlanPrepared(String planPrepared) {
    ...
    public String getPunadiBooksSupplied() {
        return punadiBooksSupplied;
    }

    public void setPunadiBooksSupplied(String punadiBooksSupplied) {
    ...
    public String getStrengthAccomodatedAsperInfrastructure() {
        return strengthAccomodatedAsperInfrastructure;
    }

    public void setStrengthAccomodatedAsperInfrastructure(String strengthAccomodatedAsperInfrastructure) {
