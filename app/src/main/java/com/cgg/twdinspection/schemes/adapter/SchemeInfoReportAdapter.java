...
public class SchemeInfoReportAdapter extends RecyclerView.Adapter<SchemeInfoReportAdapter.ItemHolder> {
    ...
    public void onBindViewHolder(@NonNull final ItemHolder holder, final int i) {
        ...
        holder.listItemBinding.cvBenReport.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                schemeClickCallback.onSchemeItemClick(String.valueOf(dataModel.getSchemeType()));
            }
        });
