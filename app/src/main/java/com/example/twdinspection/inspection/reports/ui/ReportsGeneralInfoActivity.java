        ...
        binding.btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (validateData()) {
                    ...
                    Utils.customSaveAlert(ReportsGeneralInfoActivity.this, getString(R.string.app_name), getString(R.string.are_you_sure));
                }
            }
        });
    }
    ...
    public void submitData() {
        ...
        if (x >= 0) {
            ...
            try {
                ...
                liveData.observe(ReportsGeneralInfoActivity.this, new Observer<Integer>() {
                    @Override
