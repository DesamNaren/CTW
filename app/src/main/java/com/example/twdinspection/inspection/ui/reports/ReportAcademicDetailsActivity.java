...
public class ReportAcademicDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences=TWDApplication.get(ReportAcademicDetailsActivity.this).getPreferences();
        Gson gson = new Gson();
        String data = sharedPreferences.getString(AppConstants.REP_DATA, "");
        reportData = gson.fromJson(data, InspReportData.class);

        binding.header.headerTitle.setText(getResources().getString(R.string.title_academic));
        ...
        binding.noDataTv.setText(reportData.getAcademicOverview().getProperLightFan());
        ...
        binding.bottomLl.btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ReportAcademicDetailsActivity.this, DRGodownFindingsActivity.class);
