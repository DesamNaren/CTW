...
public class DRGodownAdapter extends RecyclerView.Adapter<DRGodownAdapter.ItemHolder> {

    private Context context;
    private List<BeneficiaryDetail> list;

    public DRGodownAdapter(Context context, List<BeneficiaryDetail> list) {
