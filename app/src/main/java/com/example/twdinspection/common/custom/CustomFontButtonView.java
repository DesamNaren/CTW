package com.example.twdinspection.common.custom;
...
public class CustomFontButtonView extends Button {
    ...
    public CustomFontButtonView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        applyCustomFont(context, attrs);
    }

    @SuppressLint("NewApi")
    public CustomFontButtonView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
